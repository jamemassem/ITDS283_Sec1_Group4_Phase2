...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'GameMisstionPage',
          path: '/gameMisstionPage',
          builder: (context, params) => GameMisstionPageWidget(),
        ),
        FFRoute(
          name: 'GamePage',
          path: '/gamePage',
        ...
        FFRoute(
          name: 'Survey1',
          path: '/survey1',
          builder: (context, params) => Survey1Widget(),
        ),
        FFRoute(
          name: 'Survey2',
          path: '/survey2',
          builder: (context, params) => Survey2Widget(),
        ),
        FFRoute(
          name: 'SurveySuccessPage',
          path: '/surveySuccessPage',
          builder: (context, params) => SurveySuccessPageWidget(),
        ),
        FFRoute(
          name: 'Selectpage',
          path: '/selectpage',
